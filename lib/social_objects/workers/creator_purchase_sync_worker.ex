defmodule SocialObjects.Workers.CreatorPurchaseSyncWorker do
  @moduledoc """
  ...
  Run manually: Oban.insert(SocialObjects.Workers.CreatorPurchaseSyncWorker.new(%{}))
  """
  use Oban.Worker,
    queue: :default,
    max_attempts: 3,
  ...
  defp broadcast(brand_id, message) do
    Phoenix.PubSub.broadcast(
      ...
      "creator_purchase:sync:#{brand_id}",
      message
    )
  end
end
