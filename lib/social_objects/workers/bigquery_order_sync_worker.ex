defmodule SocialObjects.Workers.BigQueryOrderSyncWorker do
  @moduledoc """
  ...
  Call from IEx:
      SocialObjects.Workers.BigQueryOrderSyncWorker.backfill_phones(brand_id)
  """
  def backfill_phones(brand_id) do
    ...
    creators_to_fix =
      Repo.all(
        from c in SocialObjects.Creators.Creator,
          join: s in SocialObjects.Creators.CreatorSample,
  ...
  Call from IEx:
      SocialObjects.Workers.BigQueryOrderSyncWorker.backfill_emails(brand_id)
  """
