defmodule SocialObjectsWeb.TiktokLive.Index do
  @moduledoc """
  ...
  alias SocialObjects.TiktokLive, as: TiktokLiveContext
  ...
  def mount(_params, _session, socket) do
    ...
    if connected?(socket) do
      ...
      Phoenix.PubSub.subscribe(SocialObjects.PubSub, "tiktok_live:scan:#{brand_id}")
    end
    ...
    socket =
      ...
      |> assign(:dev_mode, Application.get_env(:social_objects, :dev_routes, false))
  ...
  defp maybe_subscribe_to_stream(socket, %{status: :capturing, id: stream_id}) do
    ...
    if socket.assigns.subscribed_stream_id != stream_id do
      ...
      Phoenix.PubSub.subscribe(SocialObjects.PubSub, "tiktok_live:stream:#{stream_id}")
  ...
  defp stream_report_job_status(stream_id) do
    worker_name = "SocialObjects.Workers.StreamReportWorker"
