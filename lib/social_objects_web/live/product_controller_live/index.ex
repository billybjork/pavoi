defmodule SocialObjectsWeb.ProductControllerLive.Index do
  @moduledoc """
  ...
  def mount(%{"id" => product_set_id}, _session, socket) do
    ...
    voice_assets = %{
      ...
      vad_model: SocialObjectsWeb.Endpoint.static_path("/assets/vad/silero_vad.onnx"),
      ort_wasm: SocialObjectsWeb.Endpoint.static_path("/assets/js/ort-wasm-simd-threaded.wasm"),
      ort_wasm_jsep:
        SocialObjectsWeb.Endpoint.static_path("/assets/js/ort-wasm-simd-threaded.jsep.wasm")
    }
